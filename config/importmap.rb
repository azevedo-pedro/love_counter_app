...
pin "tw-animate-css" # @1.3.2
pin "@tailwindcss/forms", to: "@tailwindcss--forms.js" # @0.5.10
pin "mini-svg-data-uri" # @1.4.4
pin "tailwindcss/colors", to: "tailwindcss--colors.js" # @4.1.8
pin "tailwindcss/defaultTheme", to: "tailwindcss--defaultTheme.js" # @4.1.8
pin "tailwindcss/plugin", to: "tailwindcss--plugin.js" # @4.1.8
